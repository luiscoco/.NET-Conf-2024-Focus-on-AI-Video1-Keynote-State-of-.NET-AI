...
{
    public static AzureOpenAIClient CreateAzureOpenAIClient1(string endpoint, bool useManagedIdentity)
    {
        return useManagedIdentity
            ? new AzureOpenAIClient(new Uri(endpoint), new DefaultAzureCredential())
            : new AzureOpenAIClient(new Uri(endpoint), new AzureKeyCredential("XXXXXXXXXXXXXXXXXX"));
    }

    public static AzureOpenAIClient CreateAzureOpenAIClient2(string endpoint, bool useManagedIdentity)
    {
        return useManagedIdentity
            ? new AzureOpenAIClient(new Uri(endpoint), new DefaultAzureCredential())
            : new AzureOpenAIClient(new Uri(endpoint), new AzureKeyCredential("XXXXXXXXXXXXXXXXXXX"));
    }
